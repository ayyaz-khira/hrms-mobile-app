      ...
      [
        { text: 'Cancel', style: 'cancel' },
        {
          ...
          onPress: async () => {
            ...
            const success = await approveLeaveRequest(request.name, 'Approver');
    ...
    Alert.alert(
      ...
      [
        { text: 'Cancel', style: 'cancel' },
        {
          ...
          onPress: async () => {
            setProcessingId(request.name);
            const success = await rejectLeaveRequest(request.name, 'Approver');
            setProcessingId(null);
            if (success) {
              setModalVisible(false);
      ...
      >
        {loading && pendingApprovals.length === 0 ? (
          ...
          <View style={[styles.emptyCard, { backgroundColor: C.card }]}>
            ...
            <Text style={[styles.emptyText, { color: C.text }]}>No Pending Approvals</Text>
            <Text style={[styles.emptySub, { color: C.subText }]}>All leave applications have been processed.</Text>
          </View>
        ) : (
          ...
          <View style={styles.modalOverlay}>
            ...
            <View style={[styles.modalCard, { backgroundColor: C.card }]}>
              <View style={styles.modalHeader}>
                <Text style={[styles.modalTitle, { color: C.text }]}>Leave Application Details</Text>
